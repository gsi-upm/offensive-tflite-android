...
public class FragmentAbout extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.about_app)).setMovementMethod(LinkMovementMethod.getInstance());
        ((TextView) view.findViewById(R.id.scroller_attribute)).setMovementMethod(LinkMovementMethod.getInstance());
        ((TextView) view.findViewById(R.id.chart_attribute)).setMovementMethod(LinkMovementMethod.getInstance());
